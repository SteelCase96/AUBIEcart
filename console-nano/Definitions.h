...
#define DRIVE_BACKWARD_CMD 'B' // drive forward
#define TURN_LEFT_CMD 'L' // rotate left
#define TURN_RIGHT_CMD 'R' // rotate right
#define TOGGLE_JOYSTICK_CMD 'J' // toggle joystick active
